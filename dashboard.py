...
app.layout = html.Div([
    ...
    html.P(dcc.Link('General Crimes', href='/page-1'),style={'text-align':'center','color':'white'}),
    html.P(dcc.Link('Rape Analysis', href='/page-2'),style={'text-align':'center','color':'white'}),
    html.Div(id='Page-content'),
    
])
# ------------------------------------------------------------------------------
# Data manipulation to produce each graphs
df=pd.read_csv(r"templates\01_District_wise_crimes_committed_IPC_2001_2012.csv")
...
victims = pd.read_csv(r'templates\20_Victims_of_rape.csv')
